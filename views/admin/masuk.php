        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm text-slate-600 divide-y divide-purple-50">
                    <?php
                    $res = mysqli_query($conn, "SELECT * FROM surat_masuk ORDER BY id DESC");
                    $no = 1;
                    ...
                    <tr class="hover:bg-purple-50/50 transition-colors">
                        ...
                        <td class="p-4 flex gap-2 justify-center">
                            ...
                            <a href="masuk.php?action=delete&id=<?= $row['id'] ?>" onclick="return confirm('Hapus data ini?');" class="text-pink-500 hover:text-pink-700 bg-pink-50 hover:bg-pink-100 px-2 py-1 rounded transition">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
