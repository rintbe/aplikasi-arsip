    ...
    <div class="bg-white rounded-2xl border border-purple-100 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-purple-50 flex flex-col md:flex-row justify-between items-center bg-gray-50/50 gap-4">
            ...
            <div class="flex items-center gap-4 w-full md:w-auto">
                <a href="export_excel.php?type=keluar" class="flex-shrink-0 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center transition-colors shadow-sm">
        ...
        <div class="p-6 border-b border-purple-50 bg-white shadow-sm">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                ...
                <div class="flex gap-2 h-[38px]">
                    ...
                    <a href="keluar.php" class="bg-slate-200 hover:bg-slate-300 text-slate-700 px-3 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm flex items-center justify-center px-4" title="Reset Filter">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm text-slate-600 divide-y divide-purple-50">
                    ...
                    if (!empty($filter_search)) {
                        ...
                        $where_clauses[] = "(nomor_surat LIKE '%$search_clean%' OR instansi_tujuan LIKE '%$search_clean%' OR perihal LIKE '%$search_clean%')";
                    }
                    ...
                    $res = mysqli_query($conn, "SELECT * FROM surat_keluar $where_sql ORDER BY id DESC");
                    $no = 1;
                    ...
                    <tr class="hover:bg-purple-50/50 transition-colors">
                        ...
                        <td class="p-4 flex gap-2 justify-center">
                            ...
                            <a href="keluar.php?action=delete&id=<?= $row['id'] ?>" onclick="confirmAction(event, this.href, 'Hapus data ini?');" class="text-pink-500 hover:text-pink-700 bg-pink-50 hover:bg-pink-100 px-2 py-1 rounded transition">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
